        ...
        <Menu.Root>
            ...
            <Menu.Portal container={document.getElementById('portal')}>
                <Menu.Content className={contentClasses} sideOffset={4} side="bottom" align="end">
                    <Menu.Item className={itemClasses} onClick={() => addScriptItem('key')}>Keystroke</Menu.Item>
                    <Menu.Item className={itemClasses} onClick={() => addScriptItem('pos')}>Position</Menu.Item>
                    <Menu.Item className={itemClasses} onClick={() => addScriptItem('field')}>Field</Menu.Item>
                    <Menu.Item className={itemClasses} onClick={() => addScriptItem('delay')}>Delay</Menu.Item>
                </Menu.Content>
            </Menu.Portal>
        </Menu.Root>
    );
